...
const Sidebar: React.FC<SidebarProps> = ({ userType, setUserType }) => {
  ...
  return (
    <aside className="w-64 min-h-screen bg-white border-r border-gray-200 fixed left-0 top-0 pt-6 pb-6 z-10 overflow-y-auto flex flex-col">
      ...
      <div className="mt-auto px-3">
        <div className="pt-4 border-t border-gray-100">
          ...
          >
            <userTypeNavItem.icon className="h-5 w-5 mr-3" />
            {userTypeNavItem.name}
          </Link>
        </div>
      </div>
    </aside>
